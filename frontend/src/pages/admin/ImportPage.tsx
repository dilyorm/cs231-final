...
export default function ImportPage() {
  ...
  function downloadTemplate(type: "json" | "csv") {
    if (type === "json") {
      const sample = [
        {
          ...
          question: "Explain what byte-oriented memory organization means.",
          followups: ["What is big-endian vs little-endian?", "Give an example with 0x12345678."],
          code_challenge: null,
        },
      ];
      ...
      const csv =
        "id,topic_number,topic,question,followups,code_challenge\n" +
        ',1,"Topic 1 – Binary Representation & Byte Ordering",' +
        '"Explain byte-oriented memory organization.",' +
        '"What is big-endian vs little-endian?|Give an example with 0x12345678.",\n';
  ...
  return (
    <div className="p-8 max-w-2xl">
      <div className="mb-6">
        ...
        <p className="text-gray-500 text-sm mt-1">Bulk-import from JSON or CSV. All imported questions are auto-approved.</p>
      </div>
      ...
      <div className="grid grid-cols-2 gap-4 mb-6">
        <div className="border border-gray-200 rounded-xl p-4">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-sm font-semibold text-gray-700">JSON format</span>
            <button
  ...
  "code_challenge": null
        ...
        <div className="border border-gray-200 rounded-xl p-4">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-sm font-semibold text-gray-700">CSV format</span>
            <button
          ...
          <pre className="text-xs text-gray-500 bg-gray-50 rounded p-2 overflow-x-auto whitespace-pre-wrap">{`topic_number,topic,question,
...
"q1?|q2?|q3?"`}</pre>
      ...
      {error && (
        <div className="mt-4 flex items-start gap-2 bg-red-50 border border-red-100 rounded-lg px-4 py-3 text-sm text-red-600">
